...
namespace Ace.Agent.BaseServices
{
  public class BaseServices : Service
  {
    ...
    #region Interfaces:InitializationRequest
    public object Post(InitializationRequest request)
    {
      var baseServicesData = HostContext.TryResolve<BaseServicesData>();
      InitializationResponse initializationResponse = new InitializationResponse(new InitializationData(baseServicesData.ConfigurationData, baseServicesData.UserData));
